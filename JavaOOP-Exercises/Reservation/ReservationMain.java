...
public class ReservationMain {
    public static void main(String[] args) {
        ResortReservation resort = new ResortReservation("RSV001", "Myla ", "2025-12-10", "A-102", true);
        RailwayReservation railway = new RailwayReservation("RSV002", "Bernardino","2025-12-11", "12B", "TR-5678");
